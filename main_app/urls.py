...
urlpatterns = [
    ...
    path("get_time_table", views.get_time_table, name='get_time_table'),
    path("get_classes", hod_views.get_classes , name='get_classes'),
    ...
    path("send_notification/", hod_views.send_notification,
         name='send_notification'),
    path("session/add", hod_views.add_session, name='add_session'),
    path("admin_notify", hod_views.admin_notify,
         name='admin_notify'),
    ...
    path("time_table/add/", hod_views.add_time_table, name='add_time_table'),
    path("staff/manage/", hod_views.manage_staff, name='manage_staff'),
    path("student/manage/", hod_views.manage_student, name='manage_student'),

    re_path(r'^student/manage/(?P<search_query>[\w\-]+)/$', 
         hod_views.manage_student, name='manage_student'),
    re_path(r'^staff/manage/(?P<search_query>[\w\-]+)/$', 
         hod_views.manage_staff, name='manage_staff'),
    ...
    path("time_table/manage/", hod_views.manage_time_table, name='manage_time_table'),
    ...
    path("class/delete/<int:class_id>",
         hod_views.delete_class, name='delete_class'),
    ...
    path('time_table/delete/<int:class_id>', 
         hod_views.delete_time_table, name='delete_time_table'),

    path('time_table/download/<str:file_name>/',
         views.download_file, name='download_time_table'),

    path("student/edit/<int:student_id>",
         hod_views.edit_student, name='edit_student'),
    path("class/edit/<int:class_id>",
         hod_views.edit_class, name='edit_class'),
    ...
    path("staff/view/notification/", staff_views.view_notification,
         name="staff_view_notification"),
    path("staff/view/time_table", staff_views.staff_view_time_table,
         name='staff_view_time_table'),
    ...
    path("student/view/notification/", student_views.view_notification,
         name="student_view_notification"),
    path('student/view/result/', student_views.student_view_result,
         name='student_view_result'),
    path("student/view/time_table", student_views.student_view_time_table,
         name='student_view_time_table'),
